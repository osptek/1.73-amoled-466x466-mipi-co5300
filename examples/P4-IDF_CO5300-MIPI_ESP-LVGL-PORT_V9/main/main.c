...
static esp_err_t app_lcd_init(void)
{
    ...
    // 创建CO5300控制面板
    esp_lcd_dpi_panel_config_t dpi_config = CO5300_466_466_PANEL_60HZ_DPI_CONFIG(MIPI_DPI_PX_FORMAT);
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_panel_co5300_set_brightness(lcd_panel, 50), err, TAG, "AMOLED init failed");
...
static esp_err_t app_touch_init(void)
{
    ...
    return esp_lcd_touch_new_i2c_cst9217(tp_io_handle, &tp_cfg, &touch_handle);
}
